...
#define PIPELINE_WIDTH 1024
    ...
    tbb::flow::function_node<rank_data*> writer( cbir, tbb::flow::serial, Write( fout, query_table, &cnt_enqueue, &cnt_dequeue ) );
    ...
    tbb::flow::make_edge(writer, limiter.decrement);
